...
const Color greenButton = Color(0xFF66CC33);
const Color blackColor = Color(0xFF000000);
const Color searchBar = Color(0xFFE8E8E8);
const Color backgroundLight = Color(0xFFF6FDFF);
const Color redColor = Color.fromARGB(255, 248, 58, 58);
const Color shadowColor = Color(0xFFDDDDDD);
